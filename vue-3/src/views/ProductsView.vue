<template>
  <div class="home">
    ...
    <!-- Pre existing code to login or use button -->
...
<script>
// import productService, productTable, productCards
...
export default {
  ...
  data() {
    return {
      isLoading: false,
      // empty array of products for products to be loaded into
      products: [],
      //empty filter to be able to filter through products
      filter: "",
      cardView: true,
    };
  },
